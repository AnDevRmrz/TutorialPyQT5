from PyQt5.QtWidgets import QDialog, QVBoxLayout, QDialogButtonBox, QGroupBox, QGroupBox, QLabel, QLineEdit, QGridLayout, QComboBox, QMessageBox
...
class Dialogo_nueva_materia(QDialog):
    ...
    def accept(self):
        ...
        dialogo_confirmacion.setText(
            "¿Está seguro que desea guardar los datos como una nueva materia?")
    ...
    def verificar_valores(self):
        if self.txt_nombre.text() == "" or self.txt_profesor.text() == "" or self.txt_nota.text() == "":
            ...
            dialogo_error.setText(
                "Los campos de la nueva materia no pueden estar vacíos")
